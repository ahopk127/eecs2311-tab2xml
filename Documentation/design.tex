...
\item \hyperref[sec:orge9c2170]{tab2xml.gui} - Frontend and GUI related code
\item \hyperref[sec:orga05c3d4]{tab2xml.model} - Abstraction of music
\item \hyperref[sec:org74dca8a]{tab2xml.parser} - Code that converts the tablature to a model representation
...
\label{sec:org53fcd95}
\subsection{Overview}
\label{sec:org2d67284}
