...
\label{sec:org9feeed7}
\subsection{Functionality}
\label{sec:org008b4e6}
\begin{itemize}
...
\end{itemize}
\section{Use Cases}
\label{sec:org5f55212}
\subsection{Convert Text Tab}
\label{sec:org8854989}
...
\item (Optional) Musician converts text tab to MusicXML (scenario of \ref{sec:org8854989}, start at step 3)
\end{enumerate}
\subsubsection{Extensions}
\label{sec:org34cf0b8}
3a. If system cannot identify instrument, or it identifies the wrong instrument, musician can choose instrument manually. \\
\subsection{Change Settings}
\label{sec:org6f9e421}
Primary Actor: Musician \\
Success Scenario:
\begin{enumerate}
