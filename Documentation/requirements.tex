...
\label{sec:org0a4ddba}
\subsection{Functionality}
\label{sec:orgbdd3dd3}
\begin{itemize}
...
\end{itemize}
\section{Use Cases}
\label{sec:org96e609f}
\subsection{Convert Text Tab}
\label{sec:orgcd3c7e5}
...
\item (Optional) Musician converts text tab to MusicXML (scenario of \ref{sec:orgcd3c7e5}, start at step 3)
\end{enumerate}
\subsubsection{Extensions}
\label{sec:orgedfda25}
3a. If system cannot identify instrument, or it identifies the wrong instrument, musician can choose instrument manually. \\
\subsection{Change Settings}
\label{sec:org143404d}
Primary Actor: Musician \\
Success Scenario:
\begin{enumerate}
