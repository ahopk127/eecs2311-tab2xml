...
\begin{center}
\includegraphics[width=.9\linewidth]{./screenshot-eclipse-build-2.png}
\end{center}
\item In the "Gradle Tasks" window, double-click the green "build" item in the "build" folder.
\begin{center}
\includegraphics[width=.9\linewidth]{./screenshot-eclipse-build.png}
\end{center}
\end{enumerate}
