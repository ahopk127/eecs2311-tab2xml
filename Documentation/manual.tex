...
\label{sec:org8cfb1c9}
\subsection{Convert Text Tab}
\label{sec:org4db650d}
\begin{enumerate}
...
\begin{enumerate}
\item Select the measure range as if you were editing it (follow \hyperref[sec:org608f550]{these steps} up to step 4).
