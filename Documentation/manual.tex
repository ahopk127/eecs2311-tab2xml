...
\label{sec:org61011be}
\subsection{Convert Text Tab}
\label{sec:orgd507e4d}
\begin{enumerate}
...
\begin{center}
\includegraphics[width=.9\linewidth]{../Screenshots/main-interface-tabbedview-0.3.0a1.png}
\end{center}
...
\end{itemize}
\begin{center}
\includegraphics[width=.9\linewidth]{../Screenshots/sample-inputs-tabbedview-0.3.0a1.png}
\end{center}
