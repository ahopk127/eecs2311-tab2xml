...
\label{sec:org76ba0ae}
\subsection{Convert Text Tab}
\label{sec:org0368798}
\begin{enumerate}
...
\begin{enumerate}
\item Select the measure range as if you were editing it (follow \hyperref[sec:org922938a]{these steps} up to step 4).
\item Input the time signature in the text boxes on the bottom-left.
\item Press the "Set Time Signature" button.
\begin{center}
\includegraphics[width=.9\linewidth]{../Screenshots/sample-input-editing-timesignature-tabbedview.png}
\end{center}
\end{enumerate}
...
\label{sec:org8df3f7c}
\subsubsection{supported features}
\label{sec:orga2f2df2}
\begin{enumerate}
