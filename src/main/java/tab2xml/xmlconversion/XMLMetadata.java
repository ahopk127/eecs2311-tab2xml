...
public final class XMLMetadata {
	...
	/**
	 * Time signature data. Each time signature is represented by an entry mapping
	 * the measure it begins on to the time signature
	 */
     ...
     * @since 2021-03-22
     */
    private XMLMetadata(String title, Map<IntRange, TimeSignature> timeSignatures) {
	this.title = title;
