...
public final class MeasureNarrowing {
	...
	public static String extractMeasureRange(String textTab, int measureStart,
		...
		return extractRectangle(textTab, topLeft.row, topLeft.col,
				bottomRight.row, bottomRight.col);
	}
	...
	public static String replaceMeasureRange(String textTab, int measureStart,
		...
		final StringPosition topLeft = topLeftCorner(textTab, measureStart);
		final StringPosition bottomRight = bottomRightCorner(textTab, measureEnd);
		return replaceRectangle(textTab, topLeft.row, topLeft.col,
				bottomRight.row, bottomRight.col, newMeasureText);
	}
