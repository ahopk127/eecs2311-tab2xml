...
class NoteTest {
	...
	static Stream<Arguments> noteNames() {
		try {
			return Stream.of(
				Arguments.of(new Note(NoteType.A, "A"), "A", 0),
				Arguments.of(new Note(NoteType.AS, "A#"), "A#", 1),
				Arguments.of(new Note(NoteType.B, "B"), "B", 2),
				Arguments.of(new Note(NoteType.C, "C"), "C", 3),
				Arguments.of(new Note(NoteType.CS, "C#"), "C#", 4),
				Arguments.of(new Note(NoteType.D, "D"), "D", 5),
				Arguments.of(new Note(NoteType.DS, "D#"), "D#", 6),
				Arguments.of(new Note(NoteType.E, "E"), "E", 7),
				Arguments.of(new Note(NoteType.F, "F"), "F", 8),
			...
			e.printStackTrace();
			fail("Exception occured during note creation.");
			return null;
		}
	}
	...
	void noteTest(Note note, String expectedName, int expectedIndex) {
		assertEquals(expectedName, note.getData());
